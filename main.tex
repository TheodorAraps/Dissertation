...
\definecolor{term.ansi.red}{HTML}{E06C75}

\newcommand{\redcolor}[1]{\textcolor{term.ansi.red}{\textbf{#1}}}
...
\lstdefinestyle{bashstyle-script}{
  language=bash,
  deletekeywords={newgrp,enable,cd,exec,cat,awk},
  backgroundcolor=\color{codebg},
  basicstyle=\linespread{1.05}\ttfamily\normalsize\color{codetext},
...
\lstdefinelanguage{TheoCXX}[]{C++}{
  ...
  morekeywords=[4]{uint8_t,uint16_t,uint32_t,int,long,short,float,double,char,bool,void,auto,signed,unsigned,size_t,std::size_t,wchar_t,char8_t,char16_t,char32_t},
  morekeywords=[5]{INVALID16,INVALID32,NUM_PZEMS,freqPlan,debugS,loraS,std,vector,string,unordered_map,map,set,optional,variant,span,array,unique_ptr,shared_ptr,make_unique,make_shared,cout,cin,endl,move,forward,chrono,thread,mutex,lock_guard,atomic},
  morekeywords=[6]{putFloatBE,putBE32,putBE,encodeScaled,isfinite,delay,begin,lroundf,isnan,millis,print,println,PZEM004Tv30,SoftwareSerial,TheThingsNetwork,resetEnergy,resetEnergyCounters,loop,setup},
  morecomment=[l]//,
  morecomment=[s]{/*}{*/},
  morestring=[b]",
  morestring=[b]',
...
\lstdefinelanguage{TheoJS}{
  sensitive=true,
  % --- core JS/ES keywords
  morekeywords={
    import,from,export,default,async,await,yield,return,
    if,else,switch,case,break,continue,try,catch,finally,throw,
    for,while,do,in,of,new,delete,typeof,instanceof,void,
    this,super,with,debugger
  },
  % --- declarations / modifiers
  morekeywords=[2]{var,let,const,function,class,extends,constructor,get,set,static},
  % --- literals & special identifiers
  morekeywords=[3]{true,false,null,undefined,NaN,Infinity},
  % --- built-ins / standard objects
  morekeywords=[4]{Array,Object,Number,String,Boolean,Math,Date,JSON,RegExp,Error,TypeError,RangeError,EvalError,URIError,Promise,Map,Set,WeakMap,WeakSet,Symbol,BigInt,Reflect,Proxy,Intl},
  % --- host / Node / DOM globals
  morekeywords=[5]{decodeUplink,readBE16,readBEu32,readBEfloat32,Uint8Array,DataView,decodePhase,push,min,floor,values,some},
  % comments & strings
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]",
...
% ---------- JavaScript style ----------
% optional: extra colors dedicated to JS groups (reuse your palette where possible)
\definecolor{js-op}{HTML}{1F6C8E} % operators (matches your cpp-op vibe)
\definecolor{js-kw2}{HTML}{ED2939} % decl/modifiers (imperial red)
\definecolor{js-kw3}{HTML}{8E44AD} % literals/special (purple)
\definecolor{js-kw4}{HTML}{0066CC} % builtins (blue)
\definecolor{js-kw5}{HTML}{2E7D32} % functions (green)

\lstdefinestyle{theo-js}{
  language=TheoJS,
  backgroundcolor=\color{codebg},
  basicstyle=\linespread{1.05}\ttfamily\small\color{codetext},
  keywordstyle=\bfseries\color{codekw},           % core keywords
  keywordstyle=[2]\bfseries\color{js-kw2},        % var/let/const/class/...
  keywordstyle=[3]\bfseries\color{js-kw3},        % true/false/null/undefined/NaN/Infinity
  keywordstyle=[4]\bfseries\color{js-kw4},        % Array/Promise/Map/...
  keywordstyle=[5]\bfseries\color{js-kw5},        % console/window/require/...
  stringstyle=\color{codestr},
  commentstyle=\itshape\color{codecm},
  numberstyle=\scriptsize\color{codenums}\noncopynumber,
  numbers=left,
  ...
  captionpos=b,
  escapechar=§,
  % make operators pop and support ES features
  literate=*
    {=>}{{{\color{js-op}\texttt{=>}}}}2
    {===}{{{\color{js-op}\texttt{===}}}}3
    {!==}{{{\color{js-op}\texttt{!==}}}}3
    ...
    {]}{{{\color{js-op}\texttt{]}}}}1
    {.}{{{\color{js-op}\texttt{.}}}}1,
  % optional: highlight ${ ... } inside template strings
  % moredelim=[is][\bfseries\color{js-kw4}]{\$\{}{\}}
}
...
\definecolor{term.ansi.yellow}{HTML}{E5C07B}
\definecolor{term.ansi.amber}{HTML}{D7A866}
...
\newcommand{\basicstation}{\textcolor{term.symbol}{BasicStation}\,}
\newcommand{\tts}{\textcolor{term.symbol}{TheThingsStack}\,}
\newcommand{\pmbackend}{\textcolor{term.symbol}{power-monitoring-backend}\,}
\newcommand{\pmfrontend}{\textcolor{term.symbol}{power-monitoring-frontend}\,}
...
\newcommand{\dockerstarted}{\textcolor{term.ansi.green}{Started}\,}
\newcommand{\dockerremoved}{\textcolor{term.ansi.green}{Removed}\,}
\newcommand{\dockerrunning}[1]{\textcolor{term.ansi.blue}{#1}}
\newcommand{\messageprompt}[1]{\textcolor{term.ansi.yellow}{#1}}
\newcommand{\successmessageprompt}[1]{\textcolor{term.ansi.green}{#1}}
% \newcommand{\magentacolor}[1]{\textcolor{term.ansi.magenta}{#1}}
