...
%   listing only,
%   colback=codebg,           % your background
%   colframe=codeframe,       % your frame color
%   arc=8pt,                  % rounded corners
%   boxrule=0.5pt,
%   left=0.2em,right=0.5em,   % match your xleft/xright margins
%   top=8pt,bottom=8pt,       % match framesep
%   listing options={style=bashstyle, frame=none, numbers=none, numbersep=10pt}
% }
% % usage:
% % \begin{CodeBlock}
% %   your code...
...
% Monospace font (optional but nice)
% For pdfLaTeX:
\usepackage[scaled=0.92]{inconsolata}
% For Xe/LuaLaTeX comment the line above and use:
% \usepackage{fontspec}
% \setmonofont{JetBrains Mono} % or Fira Code / Inconsolata, etc.

\lstdefinestyle{bashstyle}{
  language=bash,
  deletekeywords={newgrp,enable,cd},
