...
\definecolor{cpp-kw2}{HTML}{D35400}  % control-flow (orange)
...
\definecolor{cpp-pre}{HTML}{B23C17}  % preprocessor (rusty orange)
...
\lstdefinelanguage{TheoCXX}[]{C++}{
  sensitive=true,
  morekeywords={override,final,noexcept,constexpr,decltype,nullptr,thread_local,
  ...
  morekeywords=[3]{class,struct,enum,union,namespace,template,typename,using,
    public,private,protected,virtual,static,inline,explicit,friend,operator},
  morekeywords=[4]{int,long,short,float,double,char,bool,void,auto,signed,unsigned,
    size_t,std::size_t,wchar_t,char8_t,char16_t,char32_t},
  morekeywords=[5]{std,vector,string,unordered_map,map,set,optional,variant,span,array,
    unique_ptr,shared_ptr,make_unique,make_shared,cout,cin,endl,move,forward,
    chrono,thread,mutex,lock_guard,atomic},
  morecomment=[l]//,
  morecomment=[s]{/*}{*/},
  morestring=[b]",
  morestring=[b]',
...
\lstdefinestyle{theo-cpp}{
  ...
  numbers=left, numberstyle=\scriptsize\color{cpp-com}, numbersep=10pt,
