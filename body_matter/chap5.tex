...
\begin{itemize}
  ...
  \item \textbf{\en{TheThingsNetwork ttn(loraSerial, debugSerial, freqPlan)}}: Δημιουργούμε \en{TTN} \en{stack} αντικείμενο με \en{hardware UART} για \en{LoRa} και \en{USB} \en{UART} για \en{logs}.
\end{itemize}
...
\begin{itemize}
  \item \textbf{\en{debugSerial.begin(9600)}, \en{loraSerial.begin(57600)}}: Θέτουμε τα \en{baud} \en{rates}.
