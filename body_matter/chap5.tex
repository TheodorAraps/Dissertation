...
ουδέτερο \textbf{\en{N}} (\en{Neutral}). Στη συνέχεια διακλαδώνουμε την φάση σε 3 κλαδιά (κάθε κλαδί 
...
Στη συνέχεια κάνουμε \en{upload} το \rn{Arduino sketch} στο \en{The Things Uno} (βλ. Υπο-υποενότητα 
\ref{subsubsec:5.2.2.2}) και συνδέουμε τον ρευματολήπτη στην πρήζα (με προσοχή στις πολικότητες).
