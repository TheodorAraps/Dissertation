...
Το \en{Raspberry Pi 4 Model B} (βλ. Εικόνα \ref{figure4.2}) αποτελεί μια ευέλικτη και ευρύτατα διαδεδομένη πλατφόρμα μικροϋπολογιστή 
...
Το \en{iC880A-SPI} (βλ. Εικόνα \ref{figure4.2}) είναι συγκεντρωτής \en{LoRaWAN} που χρησιμοποιείται ως το κύριο στοιχείο ενός \en{gateway}, 
...
υλοποίηση επιλέχθηκε να φιλοξενηθούν με χρήση του \en{Docker} (βλ. Ενότητα \ref{section3.3}) όλες στο ίδιο μηχάνημα 
...
Ο \en{PZEM-004T V3.0} (βλ. Εικόνα \ref{figure4.3}) είναι ένας πολυλειτουργικός ψηφιακός μετρητής εναλλασσόμενης ενέργειας \en{(Alternating Current, AC)}, σχεδιασμένος για 
...
Η \en{The Things Uno} (βλ. Εικόνα \ref{figure4.3}) της εταιρείας \en{The Things Industries} βασίζεται στο \en{Arduino Leonardo} με μικροελεγκτή \en{ATmega32U4} και ενσωματωμένη μονάδα 
...
\noindent\textbf{Σημείωση:} Επιλέχθηκε η τροφοδοσία των \en{PZEM-004T v3.0} από το \en{3v3} (3.3$V$) της \en{The Things Uno} αντί για $5V$, 
διότι στην πράξη η λειτουργία στα $5V$ παρήγαγε μη έγκυρες μετρήσεις/σφάλματα στη \en{UART}. Η 
\en{The Things Uno} λειτουργεί σε λογικά επίπεδα \en{3.3V}, επομένως όταν τα \en{PZEM} τροφοδοτούνται 
στα $5V$ εκπέμπουν \en{TX} σήμα κοντά στα $5V$, κάτι που μπορεί να υπερβεί τα επιτρεπτά όρια του 
\en{RX} της πλακέτας και να οδηγήσει σε \en{framing errors}. Με τροφοδοσία στα \en{3.3$V$} τα επίπεδα 
ευθυγραμμίζονται με ασφάλεια με τη \en{UART} του μικροελεγκτή και οι μετρήσεις σταθεροποιούνται, 
χωρίς ανάγκη για ξεχωριστούς \en{level shifters}.
...
\setlength{\tabcolsep}{6pt}
\renewcommand{\arraystretch}{1.35}
\begin{tabular}{| >{\centering\arraybackslash}m{0.26\linewidth}
                | >{\centering\arraybackslash}m{0.26\linewidth}
                | >{\centering\arraybackslash}m{0.35\linewidth} |}
\hline
\multicolumn{3}{|c|}{\textbf{\en{PZEM} 1 (\en{Phase} \en{L1})}} \\ \hline
\textbf{\en{PZEM-004T v3.0} \en{pin}} & \textbf{\en{The Things Uno} \en{pin}} & \textbf{\en{Description}} \\ \hline
\en{VCC} & \en{3v3V} & Τροφοδοσία \en{3.3V} \\ \hline
\en{GND} & \en{GND} & Κοινή γείωση (\en{shared ground}) \\ \hline
\en{TX} & \en{D9}  & \en{PZEM TX} → \en{Uno RX} (\en{SoftwareSerial RX}) \\ \hline
\en{RX} & \en{D2}  & \en{PZEM RX} → \en{Uno TX} (\en{SoftwareSerial TX}) \\ \hline
\end{tabular}
\caption{Συνδεσμολογία 1\textsuperscript{ου} \en{PZEM-004T v3.0} με \en{The Things Uno} - Φάση 1}
\label{tab:ttuno_pzem_pins_phase1}
\end{table}
...
\begin{tabular}{| >{\centering\arraybackslash}m{0.26\linewidth}
                ...
                | >{\centering\arraybackslash}m{0.35\linewidth} |}
\hline
\multicolumn{3}{|c|}{\textbf{\en{PZEM} 2 (\en{Phase} \en{L2})}} \\ \hline
\textbf{\en{PZEM-004T v3.0} \en{pin}} & \textbf{\en{The Things Uno} \en{pin}} & \textbf{\en{Description}} \\ \hline
\en{VCC} & \en{3v3V}  & Τροφοδοσία \en{3.3V} \\ \hline
\en{GND} & \en{GND} & Κοινή γείωση (\en{shared ground}) \\ \hline
\en{TX}  & \en{D10} & \en{PZEM TX} → \en{TTU RX} (\en{SoftwareSerial RX}) \\ \hline
\en{RX}  & \en{D3}  & \en{PZEM RX} → \en{TTU TX} (\en{SoftwareSerial TX}) \\ \hline
\end{tabular}
\caption{Συνδεσμολογία 2\textsuperscript{ου} \en{PZEM-004T v3.0} με \en{The Things Uno} - Φάση 2}
\label{tab:ttuno_pzem_pins_phase2}
\end{table}
...
\begin{tabular}{| >{\centering\arraybackslash}m{0.26\linewidth}
                ...
                | >{\centering\arraybackslash}m{0.35\linewidth} |}
\hline
\multicolumn{3}{|c|}{\textbf{\en{PZEM} 3 (\en{Phase} \en{L3})}} \\ \hline
\textbf{\en{PZEM-004T v3.0} \en{pin}} & \textbf{\en{The Things Uno} \en{pin}} & \textbf{\en{Description}} \\ \hline
\en{VCC} & \en{3v3V}  & Τροφοδοσία \en{3.3V} \\ \hline
\en{GND} & \en{GND} & Κοινή γείωση (\en{shared ground}) \\ \hline
\en{TX}  & \en{D11} & \en{PZEM TX} → \en{TTU RX} (\en{SoftwareSerial RX}) \\ \hline
\en{RX}  & \en{D4}  & \en{PZEM RX} → \en{TTU TX} (\en{SoftwareSerial TX}) \\ \hline
\end{tabular}
\caption{Συνδεσμολογία 3\textsuperscript{ου} \en{PZEM-004T v3.0} με \en{The Things Uno} - Φάση 3}
\label{tab:ttuno_pzem_pins_phase3}
\end{table}

\medskip
\noindent\textbf{Σημείωση για την επιλογή θυρών \en{(RX)}:} 
Στο \en{The Things Uno} \en{(Leonardo/ATmega32U4)} η βιβλιοθήκη \en{SoftwareSerial} (βλ. Υπο-υποενότητα \ref{softwareserial})
μπορεί να λάβει (\en{RX}) μόνο από συγκεκριμένα ψηφιακά \en{pins} που υποστηρίζουν
\en{pin-change interrupts}. Σύμφωνα με την τεκμηρίωση για \en{Leonardo/Micro}, τα
έγκυρα \en{RX pins} είναι τα \textbf{8, 9, 10, 11, \en{14(MISO), 15(SCK), 16(MOSI)}}.
Γι’ αυτό επιλέξαμε τις \textbf{\en{D9, D10, D11}} για τη σύνδεση \en{PZEM TX} - \en{Uno RX}, ενώ τα
\en{TX} της \en{SoftwareSerial} τοποθετήθηκαν στις \textbf{\en{D2, D3, D4}}. Έτσι
αποφεύγουμε διενέξεις με το υλικό \en{UART} (\textbf{\en{Serial1}} στους \textbf{\en{D0/D1}}),
το οποίο κρατάμε διαθέσιμο για τη \en{LoRa}/\en{TTS} επικοινωνία και ταυτόχρονα
εξασφαλίζουμε αξιόπιστο χρονισμό σε τυπικές \en{baud rates} (π.χ. 9600-38400).
Βλ. και τις οδηγίες \en{Arduino} για \en{SoftwareSerial} και \en{The Things Uno}
(προφίλ \en{Leonardo}) \cite{TTI_TheThingsStackDocs,swserial_leo_pins,arduino_swserial}.
\medskip

Στην πλευρά των βιδωτών ακροδεκτών (\en{screw terminals}, δεξία μερία των \en{PZEM} στην Εικόνα \ref{figure4.3}) το 
\en{PZEM-004T v3.0} υπάρχουν δύο ζεύγη επαφών: το ζεύγος φάσης/ουδέτερου (\textbf{\en{Live}/\en{Neutral}}) για 
την τάση από το δίκτυο και το ζεύγος εισόδου \textbf{\en{CT} (+/-)} για τον 
μετασχηματιστή ρεύματος. Η φάση \en{L} και ο ουδέτερος \en{N} συνδέονται απευθείας 
στα αντίστοιχα καλώδια του τριφασικού/μονοφασικού κλάδου που μετράμε, ώστε το \en{module}
να μετράει την τάση (\en{voltage}) και να τροφοδοτείται. Ο \en{CT} «αγκαλιάζει» μόνο 
τον αγωγό της φάσης (όχι τον ουδέτερο) και τα δύο του καλώδια πηγαίνουν στους ακροδέκτες 
\en{CT (+)} και \en{CT (-)} του \en{PZEM} ώστε το \en{module} να μετράει το ρεύμα (\en{current}). 
Φροντίζουμε ο προσανατολισμός να ταιριάζει με το βέλος/σήμανση του \en{CT} ώστε η φορά ισχύος 
να είναι σωστή. Το \en{PZEM} υπολογίζει στη συνέχεια τις μετρήσεις \en{power}, 
\en{energy}, \en{frequency} και \en{power factor}. 

\noindent\textbf{Σημείωση:} Λόγω της αρχιτεκτονικής του \en{PZEM-004T v3.0}, οι μετρήσεις 
ρεύματος/ισχύος δεν φέρουν πρόσημο ούτε πληροφορία γωνίας φάσης, επομένως \textbf{δεν είναι δυνατή 
η διάκριση κατεύθυνσης ροής} (εισροή/εκροή) και η «αντίστροφη» ισχύς δεν μπορεί να 
αναγνωριστεί από τη συσκευή. Τέλος, το \en{PZEM-004T v3.0} \textbf{δεν υπολογίζει αρμονικές 
ούτε \en{THD}}, αλλά εκθέτει μόνο \en{RMS} τιμές τάσης/ρεύματος, ενεργό ισχύ, ενέργεια, συχνότητα και 
\en{power factor}, χωρίς φασματική ανάλυση.
