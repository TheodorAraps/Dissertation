...
\en{VCC} & \en{3v3V}  & Τροφοδοσία \en{3.3V} \\ \hline
\en{GND} & \en{GND} & Κοινή γείωση (\en{shared ground}) \\ \hline
\en{TX}  & \en{D10} & \en{PZEM TX} → \en{Uno RX} (\en{SoftwareSerial RX}) \\ \hline
\en{RX}  & \en{D3}  & \en{PZEM RX} → \en{Uno TX} (\en{SoftwareSerial TX}) \\ \hline
\end{tabular}
...
\en{VCC} & \en{3v3V}  & Τροφοδοσία \en{3.3V} \\ \hline
\en{GND} & \en{GND} & Κοινή γείωση (\en{shared ground}) \\ \hline
\en{TX}  & \en{D11} & \en{PZEM TX} → \en{Uno RX} (\en{SoftwareSerial RX}) \\ \hline
\en{RX}  & \en{D4}  & \en{PZEM RX} → \en{Uno TX} (\en{SoftwareSerial TX}) \\ \hline
\end{tabular}
