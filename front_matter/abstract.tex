...
μέσω ενός \en{LoRaWAN gateway}, το οποίο βασίζεται σε ένα \en{Raspberry Pi 4B}, μία μονάδα 
συγκέντρωσης \en{iC880A-SPI} και μία κεραία υψηλού κέρδους. Το λογισμικό περιλαμβάνει 
...
σε \en{Java Spring Boot} και \en{React}.
