...
συγκέντρωσης \en{iC880A-SPI} και μία κεραία σχετικά χαμηλού κέρδους των \en{2dBi}. Το λογισμικό περιλαμβάνει 
...
αξιοποιώντας το \en{web framework} \en{Spring Boot} της \en{JAVA} και τη βιβλιοθήκη \en{React} της \en{JavaScript}.
